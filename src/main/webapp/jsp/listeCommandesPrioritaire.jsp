...
<html>
<head>
    <title>Commandes en cours de preparation</title>
...
<h2 class="text-center">📦 Liste des Commandes en cours de preparation</h2>
...
<form action="ServletConfirmerSelectionFinal" method="post">
    <table class="table table-bordered table-striped">
        ...
        <tr>
            ...
            <th>Finaliser la commande</th>   <!-- ✅ Nouvelle colonne pour le finaliser -->
            <th>Sélectionner</th>
        </tr>
        </thead>
        <tbody>
    ...
    <div class="d-flex justify-content-between mt-3">
        <a href="commande?action=listePreparations" class="btn btn-secondary">
            <i class="fa-solid fa-arrow-left"></i> Retour à la liste
        </a>
        <button type="submit" class="btn btn-primary">
            <i class="fa-solid fa-check"></i> Selectionnez des Commandes Pretes
        </button>
    </div>
</form>
