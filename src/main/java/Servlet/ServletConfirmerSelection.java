 ...
 */
@WebServlet("/ServletConfirmerSelection")
public class ServletConfirmerSelection extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (commandesSelectionnees != null && commandesSelectionnees.length > 0) {
            ...
            request.getRequestDispatcher("jsp/confirmerSelection.jsp").forward(request, response);
        } else {
